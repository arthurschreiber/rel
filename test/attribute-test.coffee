...
describe 'Attribute', ->
  ...
  describe '#notEq', ->
    ...
    it 'should generate != in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE "users"."id" != 10'

    it 'should handle null', ->
      relation = new Table('users')
      mgr = relation.project relation.column('id')
      mgr.where relation.column('id').notEq(null)
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE "users"."id" IS NOT NULL'
  ...
  describe '#notEqAny', ->
    ...
    it 'should generate ORs in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE ("users"."id" != 1 OR "users"."id" != 2)'
  ...
  describe '#notEqAll', ->
    ...
    it 'should generate ANDs in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE ("users"."id" != 1 AND "users"."id" != 2)'
  ...
  describe '#gt', ->
    ...
    it 'should handle comparing with a subquery', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT * FROM "users" WHERE "users"."karma" > (SELECT AVG("users"."karma") FROM "users")'
  ...
  describe '#average', ->
    ...
    it 'should generate proper sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT AVG("users"."id") FROM "users"'
  ...
  describe '#maximum', ->
    ...
    it 'should generate proper sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT MAX("users"."id") FROM "users"'
  ...
  describe '#minimum', ->
    ...
    it 'should generate proper sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT MIN("users"."id") FROM "users"'
  ...
  describe '#sum', ->
    ...
    it 'should generate proper sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT SUM("users"."id") FROM "users"'
  ...
  describe '#count', ->
    ...
    it 'should generate proper sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT COUNT("users"."id") FROM "users"'
  ...
  describe '#eq', ->
    ...
    it 'should handle null', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE "users"."id" IS NULL'
  ...
  describe '#matches', ->
    ...
    it 'should generate LIKE in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE "users"."name" LIKE \'%bacon%\''
  ...
  describe '#matchesAny', ->
    ...
    it 'should generate ORs in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE ("users"."name" LIKE \'%chunky%\' OR "users"."name" LIKE \'%bacon%\')'
  ...
  describe '#matchesAll', ->
    ...
    it 'should generate ANDs in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE ("users"."name" LIKE \'%chunky%\' AND "users"."name" LIKE \'%bacon%\')'
  ...
  describe '#doesNotMatch', ->
    ...
    it 'should generate LIKE in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE "users"."name" NOT LIKE \'%bacon%\''
  ...
  describe '#doesNotMatchAny', ->
    ...
    it 'should generate ORs in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE ("users"."name" NOT LIKE \'%chunky%\' OR "users"."name" NOT LIKE \'%bacon%\')'
  ...
  describe '#doesNotMatchAll', ->
    ...
    it 'should generate ANDs in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE ("users"."name" NOT LIKE \'%chunky%\' AND "users"."name" NOT LIKE \'%bacon%\')'
  ...
  describe '#in', ->
    ...
    it 'should generate IN sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE "users"."id" IN (1, 2, 3)'
  ...
  describe '#inAny', ->
    ...
    it 'should generate ORs in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE ("users"."id" IN (1, 2) OR "users"."id" IN (3, 4))'
  ...
  describe '#inAll', ->
    ...
    it 'should generate ANDs in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE ("users"."id" IN (1, 2) AND "users"."id" IN (3, 4))'
  ...
  describe '#notIn', ->
    ...
    it 'should generate IN sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE "users"."id" NOT IN (1, 2, 3)'
  ...
  describe '#notInAny', ->
    ...
    it 'should generate ORs in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE ("users"."id" NOT IN (1, 2) OR "users"."id" NOT IN (3, 4))'
  ...
  describe '#notInAll', ->
    ...
    it 'should generate ANDs in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" WHERE ("users"."id" NOT IN (1, 2) AND "users"."id" NOT IN (3, 4))'
  ...
  describe '#asc', ->
    ...
    it 'should generate ASC in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" ORDER BY "users"."id" ASC'
  ...
  describe '#desc', ->
    ...
    it 'should generate DESC in sql', ->
      ...
      assert.equal mgr.toSql(@engine), 'SELECT "users"."id" FROM "users" ORDER BY "users"."id" DESC'
